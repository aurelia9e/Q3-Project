	function calculate(){
			...
			if (start === "buendia" && stop === "northavenue") {
			price = 24; }
			else if (start==="buendia" && stop === "quezonavenue") {
			price = 24; }
			else if (start === "buendia" && stop === "kamuning") {
			price = 20; }
			else if (start === "buendia" && stop === "araneta") {
			price = 20; }
			else if (start === "buendia" && stop === "santolan") {
			price = 20; }
			else if (start === "buendia" && stop === "ortigas") {
			price = 16; }
			else if (start === "buendia" && stop === "shaw") {
			price = 16; }
			else if (start === "buendia" && stop === "boni") {
			price = 13; }
			else if (start === "buendia" && stop === "guadalupe") {
			price = 13; }
			else if (start === "buendia" && stop === "buendia") {
			price = 0; }
			else if (start === "buendia" && stop === "ayala") {
			price = 13; }
			else if (start === "buendia" && stop === "magallanes") {
			price = 13; }
			else if (start === "buendia" && stop === "taft ") {
			price = 16; }
